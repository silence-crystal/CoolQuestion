...
public class CTBActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private List<Question> ctb_question_list;//存放错题的集合
    ...
    public void InitView(){
        ...
        ctb_question_list=new ArrayList<Question>();
...
//                menu.addMenuItem(openItem);
    ...
    private void AddData() {
        for (int i=0;i<14;i++){
            Question question=new Question("Paython专项练习"+(i+1),"你写的第二个程序是什么？","A","B","C","D","A","这你也能错？");
            ctb_question_list.add(question);
        }
    }
